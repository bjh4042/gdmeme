...
const RULES: Rule[] = [
  ...
  { key: "bullying", threshold: 3, icon: "🙁", text: "친구를 놀리거나 소외시키는 말이 될 수 있어요." },
  { key: "discrimination", threshold: 3, icon: "⚖️", text: "사람의 특징이나 배경을 낮추는 표현이 될 수 있어요." },
  { key: "violence", threshold: 3, icon: "⚠️", text: "위험하거나 자극적인 행동을 가볍게 여기게 할 수 있어요." },
  { key: "grammar_destruction", threshold: 3, icon: "✍️", text: "공식적인 상황에서는 뜻이 잘 전달되지 않을 수 있어요." },
];
