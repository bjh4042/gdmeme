...
const APPROVED_SAMPLES: {
  ...
  {
    word: "어쩔티비",
    def: "'어쩌라고, 저리 가'라는 뜻으로 상대를 무시할 때 쓰는 유행어",
    alt: ["그렇구나", "네 생각을 존중해"],
    source: "유튜브 쇼츠",
    score: 42,
  },
  {
    word: "누칼협",
    def: "'누가 칼 들고 협박했냐'의 줄임말로 상대의 상황을 비꼬는 말",
    alt: ["네가 선택한 일이잖아", "스스로 정한 거지"],
    source: "인터넷 커뮤니티",
    score: 46,
  },
  {
    word: "핑프",
    def: "'핑거 프린세스/프린스'의 줄임말로 검색 안 하고 물어보는 사람을 비꼼",
    alt: ["먼저 찾아보고 물어봐 줘", "같이 검색해 볼까"],
    source: "카카오톡 단톡방",
    score: 38,
  },
  {
    word: "킹받네",
    def: "매우 화가 난다는 뜻을 재미있게 표현한 유행어",
    alt: ["정말 속상해", "많이 답답해"],
    source: "인스타 릴스",
    score: 34,
  },
  {
    word: "뇌절",
    def: "같은 말이나 행동을 계속 반복해서 질리게 한다는 뜻",
    alt: ["같은 이야기 그만", "한 번이면 충분해"],
    source: "유튜브 댓글",
    score: 30,
  },
  {
    word: "중꺾마",
    def: "'중요한 건 꺾이지 않는 마음'의 줄임말로 포기하지 않는 태도",
    alt: ["끝까지 해보는 마음", "포기하지 않는 용기"],
    source: "e스포츠 중계",
    score: 18,
  },
  {
    word: "알잘딱깔센",
    def: "'알아서 잘 딱 깔끔하고 센스 있게'의 줄임말",
    alt: ["스스로 잘 정리해서", "센스 있게 알아서"],
    source: "숏폼",
    score: 26,
  },
  {
  ...
  {
    word: "오운완",
    def: "'오늘 운동 완료'의 줄임말로 운동을 마쳤다는 자랑",
    alt: ["오늘 운동 다 했어요"],
    source: "인스타 스토리",
    score: 16,
  },
  {
    word: "쿠쿠루삥뽕",
    def: "상대를 놀리듯 약 올릴 때 쓰는 유행어",
    alt: ["그만 놀리자", "친구가 속상해할 수 있어"],
    source: "틱톡",
    score: 44,
  },
  {
    word: "킹리적갓심",
    def: "'합리적 의심'을 과장한 유행어",
    alt: ["합리적인 의심", "그럴듯한 추측"],
    source: "유튜브 예능",
    score: 24,
  },
