...
export const WEATHER_MATRIX: WeatherTier[] = [
  {
    ...
    icon: "☀️",
    label: "아주 맑음(쾌청)",
    desc: "최고의 청정 교실! 우리 반은 비속어가 전혀 없는 바른말 수호 구역입니다.",
    tone: "safe",
  ...
  },
  {
    ...
    icon: "🌤️",
    label: "구름 조금(맑음)",
    desc: "아주 양호해요. 서로를 존중하며 고운 말 약속을 훌륭하게 실천하고 있습니다.",
    tone: "safe",
  ...
  },
  {
    ...
    icon: "⛅",
    label: "구름 사이 햇살(개임)",
    desc: "무난한 상태입니다. 유행어가 가끔 들리지만 금방 바른말로 자정하고 있어요.",
    tone: "safe",
  ...
  },
  {
    ...
    icon: "☁️",
    label: "구름 많음(흐림)",
    desc: "주의가 필요해요! 무분별한 밈과 신조어가 교실에 번지기 시작했습니다.",
    tone: "warn",
  ...
  },
  {
    ...
    icon: "🌦️",
    label: "한때 비(소나기)",
    desc: "경고 단계입니다! 거친 말투와 은어가 섞여 나와 친구들 사이에 다툼이 생길 수 있어요.",
    tone: "warn",
  ...
  },
  {
    ...
    icon: "🌧️",
    label: "장마비(비바람)",
    desc: "위험해요! 교실 언어가 오염되어 어두운 구름이 가득합니다. 예절 역할극을 점검하세요.",
    tone: "danger",
  ...
  },
  {
    ...
    icon: "⚡",
    label: "천둥번개(폭풍우)",
    desc: "비상사태! 유해한 비속어가 가득합니다. 당장 바른말 수호 대책이 시급합니다.",
    tone: "danger",
...
export function weatherOf(avg: number) {
  ...
  const tier =
    WEATHER_MATRIX.find((t) => clamped >= t.min && clamped <= t.max) ?? WEATHER_MATRIX[0];
